...
\chapter*{{\authorDeclarationTitle}}\label{chapter:declaration} % This creates an unnumbered chapter titled "Autorideklaratsioon" and centers the text. The \label{chapter:declaration} creates a reference label for this chapter.
...
\chapter*{LÕPUTÖÖ ÜLESANNE}\label{chapter:assignment}
\input{misc/thesis-assignment.tex}
\pagebreak

\chapter*{{\abstactTitle}}\label{chapter:abstract}
...
\chapter*{
    {\secondAbstractTitle}\\[24pt] % Adds a 12pt space below \secondAbstractTitle
    {\large\abstractThesisTitle}
}\label{chapter:abstract-english}
\ifthenelse{\equal{\lang}{ENG}}
    {\input{misc/abstract-estonian.tex}}
    {\input{misc/abstract-english.tex}}
\pagebreak

\chapter*{Eessõna}\label{chapter:foreword}
\input{misc/foreword.tex}
\pagebreak

\chapter*{{\listOfTermsTitle}}\label{chapter:terms}
