...
\caption{Põhiprogrammi lihtsustatud plokkskeem}\label{fig:image16}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=6.10174in,height=0.33333in]{media/image17.png}
\caption{Põhiprogrammi käitamise näide käsurealt}\label{fig:image17}
\end{figure}
...
\caption{Masinnägemise programmi toimimise lihtsustatud plokkskeem}\label{fig:image18}
\end{figure}
...
\caption{Arhitektuuripõhiste parameetrite initsialiseerimine}\label{fig:image19}
\end{figure}
...
\caption{Kaadrile kuvatud närvivõrgu poolt genereeritud ja töödeldud tuvastused (kastid ja nende sees olevad tuvastatud klassid koos tõenäosustega)}\label{fig:image20}
\end{figure}
...
Teise probleemina ei olnud võimalik suuremaid masinnägemise mudeleid edukalt jooksutada, kuna mudelid laeti protsessori mällu ning marginaalne osa arvutuslikust tööst koos kaadrite töötlusega närvivõrgus kandus graafikakaardile (vt Joonis~\ref{fig:image21}).

\begin{figure}[H]
\centering
\includegraphics[width=5.94792in,height=4.05208in]{media/image21.png}
\caption{YOLOv5l, ühe sisendiga, resolutsioonil 640x640 pikslit, optimeerimata mudeli jooksmine ei utiliseeri kogu graafikakaarti, monitooringurakenduses jtop \cite{ref43}}\label{fig:image21}
\end{figure}
...
Optimeerimiste tulemusena (vt Joonis~\ref{fig:image22}) on:
...
\caption{YOLOv5l, ühe sisendiga, resolutsioonil 640x640 pikslit, optimeeritud mudeli jooksmine utiliseerib kogu graafikakaardi}\label{fig:image22}
\end{figure}
