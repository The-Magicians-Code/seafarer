...
Jetsonite seeriasse kuuluvad 4 seadet: Nano, TX2, Xavier NX ning AGX Xavier, mille hulgast viimane kõige võimekam (vt Tabel~\ref{tab:3-1-1}). Nano on kõige algelisem versioon, millega saab lihtsaimaid masinnägemise rakendusi valmistada, TX2 on sellest mõnevõrra võimekam protsessori ning graafikakaardi arvutusvõimsuse kohalt ning Xavier NX ning AGX Xavier on mõeldud tööstuslikkele kasutusaladele ning nende eelisteks on kuue- ja kaheksatuumalised protsessorid ning Volta arhitektuuriga graafikakaardid, mis sisaldavad ka endas maatriksoperatsioonide kiirendeid (\emph{Tensor Cores}) \cite{ref24}, (vt Joonis~\ref{fig:image7}).
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{0.2568\linewidth}@{}}
\caption{Jetson seeria arvutite parameetrid \cite{ref24}}\label{tab:3-1-1}\\
\toprule\noalign{}
\endhead
\bottomrule\noalign{}
\endlastfoot
...
\caption{Jetson AGX Xavieri ja Xavier NXi parameetrid \cite{ref24}}\label{tab:3-1-2}\\
\toprule\noalign{}
\endhead
\bottomrule\noalign{}
\endlastfoot
...
Seadmed, mis eelmainitud parameetrile vastaksid on järgnevad (vt Tabel~\ref{tab:3-3-1}):
...
\caption{Parameetritele sobilikud kaamerad}\label{tab:3-3-1}\\
\toprule\noalign{}
\endhead
\bottomrule\noalign{}
\endlastfoot
