...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{0.2568\linewidth}@{}}
\caption{Tabel 3.1.1. Jetson seeria arvutite parameetrid \cite{ref24}}\\
\toprule\noalign{}
\endhead
\bottomrule\noalign{}
\endlastfoot
...
\caption{Tabel 3.1.2. Jetson AGX Xavieri ja Xavier NXi parameetrid \cite{ref24}}\\
\toprule\noalign{}
\endhead
\bottomrule\noalign{}
\endlastfoot
...
\caption{Joonis 3.1.1. Valitud arvuti: Jetson AGX Xavier (paremal ilma jahutusplokita) \cite{ref26}}
\end{figure}
...
\caption{Joonis 3.2.1. Tensor Core, kolmedimensiooniliste 4x4x4 maatriksite korrutamine ning summeerimine \cite{ref27}}
\end{figure}
...
\caption{Tabel 3.3.1. Parameetritele sobilikud kaamerad}\\
\toprule\noalign{}
\endhead
\bottomrule\noalign{}
\endlastfoot
...
\caption{Joonis 3.3.1. Arducam Fisheye kaameraga moodul \cite{ref34}}
\end{figure}
...
\caption{Joonis 3.4.2. Juhttorni asetus patrulllaeval \cite{ref35}}
\end{figure}
