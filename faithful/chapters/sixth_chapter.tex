...
\caption{Mudelite jõudlus 1 kaadri sisendiga, suurusel 640x640 pikslit}\label{fig:image24}
\end{figure}
...
\caption{Mudelite jõudlus 1 kaadri sisendiga, suurusel 1280x1280 pikslit}\label{fig:image25}
\end{figure}
...
\caption{Mudelite jõudlus 3 kaadri sisendiga paralleelselt, suurusel 640x640 pikslit}\label{fig:image26}
\end{figure}
...
\caption{Mudelite jõudlus 3 kaadri sisendiga paralleelselt, suurusel 1280x1280 pikslit}\label{fig:image27}
\end{figure}
