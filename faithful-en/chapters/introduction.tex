...
Tallinn University of Technology and AS Baltic Workboats are partners in a project whose aim is to carry out vessel sea trials autonomously, i.e.\ without human involvement (see Figure~\ref{fig:image3}) \cite{ref11}. There are also plans for further development in the same field, to apply autonomous systems beyond sea trials and give vessels the ability to perform tasks and navigate at sea independently.

\begin{figure}[H]
\centering
\includegraphics[width=6.10278in,height=2.45694in]{media/image3.jpg}
\caption{Baltic Workboats' Navy 18 WP patrol vessels \cite{ref12}}\label{fig:image3}
\end{figure}
