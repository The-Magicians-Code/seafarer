...
\caption{The image, represented as a matrix (left), is operated on with the filter (centre), producing a dot product as a feature map (right).}\label{fig:image5}
\end{figure}
