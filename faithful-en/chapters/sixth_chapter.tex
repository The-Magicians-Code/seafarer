...
\caption{Figure 6.2.1. Model performance with a single 640$\times$640-pixel frame input}
\end{figure}
...
\caption{Figure 6.2.2. Model performance with a single 1280$\times$1280-pixel frame input}
\end{figure}
...
\caption{Figure 6.2.3. Model performance with three 640$\times$640-pixel frame inputs in parallel}
\end{figure}
...
\caption{Figure 6.2.4. Model performance with three 1280$\times$1280-pixel frame inputs in parallel}
\end{figure}
