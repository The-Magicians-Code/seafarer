...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{0.2568\linewidth}@{}}
\caption{Table 3.1.1. Parameters of the Jetson-series computers \cite{ref24}}\\
\toprule\noalign{}
\endhead
\bottomrule\noalign{}
\endlastfoot
...
\caption{Table 3.1.2. Parameters of the Jetson AGX Xavier and the Xavier NX \cite{ref24}}\\
\toprule\noalign{}
\endhead
\bottomrule\noalign{}
\endlastfoot
...
\caption{Figure 3.1.1. The chosen computer: the Jetson AGX Xavier (right, without the heat-sink module) \cite{ref26}}
\end{figure}
...
\caption{Figure 3.2.1. A Tensor Core multiplying and summing three-dimensional 4$\times$4$\times$4 matrices \cite{ref27}}
\end{figure}
...
\caption{Table 3.3.1. Cameras matching the parameters}\\
\toprule\noalign{}
\endhead
\bottomrule\noalign{}
\endlastfoot
