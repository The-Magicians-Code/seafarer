...
\newcommand{\lang}{ENG} % Choose the language of the thesis (Estonian is the default one)
...
\newcommand{\thesisTitleEng}{Improving situational awareness of autonomous vessels using computer vision} % variable with thesis title
\newcommand{\thesisTitleEst}{Autonoomse laeva situatsiooniteadlikkuse arendamine masinnägemise abil} % Title in Estonian

% Choose your thesis
\newcommand{\thesisType}{Bachelor's Thesis}

% Thesis author
\newcommand{\authorName}{Tanel Treuberg}
\newcommand{\studentcode}{193761EAAB}
...
\newcommand{\signatureDate}{2023}

% PDF Metadata
\newcommand{\version}{1.0}
\newcommand{\keywords}{autonomous vessel, computer vision, situational awareness, object detection, maritime, deep learning}
...
\newcommand{\schoolEng}{School of Engineering\\Department of Electrical Power Engineering and Mechatronics}
\newcommand{\universityEst}{TALLINNA TEHNIKAÜLIKOOL}
\newcommand{\schoolEst}{Inseneriteaduskond\\Elektroenergeetika ja mehhatroonika instituut}
